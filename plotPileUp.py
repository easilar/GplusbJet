...
data_pufile = ROOT.TFile("PUfiles/PileupHistogram-goldenJSON-13tev-2016-postVFP-69200ub-99bins.root")
...
data_pufile_p5 = ROOT.TFile("PUfiles/PileupHistogram-goldenJSON-13tev-2016-postVFP-72400ub-99bins.root")
...
data_pufile_m5 = ROOT.TFile("PUfiles/PileupHistogram-goldenJSON-13tev-2016-postVFP-66000ub-99bins.root")
...
sname = "G1Jet_Pt"
stype = "signal"
gjets = sample_dic[2016]["signal"]["G1Jet_LHEGPt_PreVFP"]
cut = "(1)"
...
leg.AddEntry(h_mc, "MC 2016 postVFP 25ns UL","l")
...
cb.cd()
cb.Draw()
cb.SaveAs("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/Plots/UL/2016_postVFP/PileUP/nTrueInt_G1Jet.png")
cb.SaveAs("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/Plots/UL/2016_postVFP/PileUP/nTrueInt_G1Jet.pdf")
cb.SaveAs("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/Plots/UL/2016_postVFP/PileUP/nTrueInt_G1Jet.root")
h_ratio.SaveAs("PUfiles/puCorrection_2016_postVFPUL.root")
