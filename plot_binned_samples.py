...
ch = ch_data[0]
#plot = getPlotFromChain(ch,"Photon_pt[0]",(40,0,2000),cutString = cut ,weight="(1)")
...
leg.Draw()
cb.Draw()
cb.SaveAs("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/Plots/Test_Plots/HT_presel.png")
cb.SaveAs("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/Plots/Test_Plots/HT_presel.pdf")
cb.SaveAs("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/Plots/Test_Plots/HT_presel.root")
