...
#start data
h_data_den = getPlotFromChain(c, plot['var'],(50,0,150) ,cutString =den_cut , weight = "(1)" ,addOverFlowBin='both') 
h_data_num = getPlotFromChain(c, plot['var'],(50,0,150)  ,cutString =num_cut , weight = "(1)" ,addOverFlowBin='both') 
...
func = ROOT.TF1("func", "([0]/(1+ TMath::Exp(-[1]*(x-[2]))))", 0., 150.) 
