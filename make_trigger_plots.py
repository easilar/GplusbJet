...
num_cut = "&&".join(["ngoodPhoton==1",ref_trigger,"weight_trig_HLT_Photon120>0",prob_trigger])
den_cut = "&&".join(["ngoodPhoton==1",ref_trigger,"weight_trig_HLT_Photon120>0"])
print(num_cut)
print(den_cut)
#c = data_dict["chain"]
...
h_data_num = getPlotFromChain(c, plot['var'], plot['bin'], cutString =num_cut , weight = data_dict_120["weight"] ,addOverFlowBin='both',variableBinning=plot["bin_set"]) 
...
cb.SaveAs(plots_path+plot['title']+data_dict_120["tex"]+'_trig_'+prob_trigger+'_Trig_Weight.png')
cb.SaveAs(plots_path+plot['title']+data_dict_120["tex"]+'_trig_'+prob_trigger+'_Trig_Weight.pdf')
cb.SaveAs(plots_path+plot['title']+data_dict_120["tex"]+'_trig_'+prob_trigger+'_Trig_Weight.root')
cb.Clear()
