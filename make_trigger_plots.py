...
data_dict_165 = {"sample":"SinglePhoton", "weight":"(weight_trig_HLT_Photon165*(weight_trig_HLT_Photon165>0.0)", "chain":chain_165, "tex":"SinglePhoton", "color":ROOT.kBlack}
...
'''
chain_165 = ROOT.TChain("Events")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016B_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016C_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016D_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016E_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016F_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016G_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
chain_165.Add("/eos/user/e/ecasilar/SMPVJ_Gamma_BJETS/data/2016/SingleMuon/Low_PT/Run2016H_02Apr2020-v1/merged_HLT_165/HLT_Photon165_R9Id90_*.root")
#data_dict_120 = {"sample":"SingleMuon", "weight":"(1)", "chain":chain_90, "tex":"SingleMuon", "color":ROOT.kBlack}
data_dict_165 = {"sample":"SingleMuon", "weight":"(weight_trig_HLT_Photon165)", "chain":chain_165, "tex":"SingleMuon", "color":ROOT.kBlack}
...
num_cut = "&&".join(["ngoodPhoton==1",ref_trigger,"weight_trig_HLT_Photon165>0",prob_trigger])
den_cut = "&&".join(["ngoodPhoton==1",ref_trigger,"weight_trig_HLT_Photon165>0"])
print(num_cut)
print(den_cut)
#c = data_dict["chain"]
#c = data_dict_120["chain"]
c = data_dict_165["chain"]
...
h_data_num = getPlotFromChain(c, plot['var'], plot['bin'], cutString =num_cut , weight = data_dict_165["weight"] ,addOverFlowBin='both',variableBinning=plot["bin_set"]) 
...
#tex.DrawLatex(0.2,0.7,"weight = HLT_Photon_120_R9Id90_HE10_IsoM")
...
cb.SaveAs(plots_path+plot['title']+data_dict_165["tex"]+'_trig_'+prob_trigger+'_Trig_Weight_Val.png')
cb.SaveAs(plots_path+plot['title']+data_dict_165["tex"]+'_trig_'+prob_trigger+'_Trig_Weight_Val.pdf')
cb.SaveAs(plots_path+plot['title']+data_dict_165["tex"]+'_trig_'+prob_trigger+'_Trig_Weight_Val.root')
cb.Clear()
