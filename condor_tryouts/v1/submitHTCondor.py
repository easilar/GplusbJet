...
parser.add_argument("--log_dir", default="/afs/cern.ch/user/m/myalvac/gplusjets/logs/", help="location of log files. Make sure dir exists or jobs will be held hostage.")
parser.add_argument("--junk_dir", default="/afs/cern.ch/user/m/myalvac/gplusjets/junk/")
